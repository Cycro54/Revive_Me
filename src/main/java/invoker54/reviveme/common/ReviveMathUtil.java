...
public class ReviveMathUtil {
    ...
    public static int getExperienceFromLevel(Player player){
    ...
    public static void fixExperience(Player player){
        player.totalExperience = getExperienceFromLevel(player.experienceLevel, player.experienceProgress);
    }

    public static void giveExperience(Player player, int experience){
