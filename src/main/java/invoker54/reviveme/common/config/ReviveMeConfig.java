...
public final class ReviveMeConfig {
    ...
    public static List<EffectInstance> reviveEffects = new ArrayList<>();
    ...
    public static List<Effect> harmfulEffects = new ArrayList<>();
...
//        if (selfReviveOptions.isEmpty()) selfReviveOptions.add(SELFREVIVETYPE.CHANCE);
        ...
        Stream<Effect> negativeEffects = ForgeRegistries.POTIONS.getValues().stream().filter(e -> e.getCategory() == EffectType.HARMFUL);
...
//        overhealPenaltyPercentage = mainTag.getDouble("overhealPenaltyPercentage");
        ...
        ReviveItemData.deserializeNBT((CompoundNBT) mainTag.get(ReviveItemData.MAIN_REVIVE_ITEM_NBT));
    }
    ...
    public static class CommonConfig {
        ...
        public CommonConfig(ForgeConfigSpec.Builder builder) {
            ...
            revertEffectBlacklist = builder.comment("What effects you won't gain back on revive. Add \"//\" to make it a whitelist instead. Add ';EffectType;' to block/allow effect categories. " +
                    "Usage: (ModId:PotionEffect) 'minecraft:slowness' or 'slowness' or 'minecraft'. Usage2: (EffectType) ';HARMFUL;' or ';NEUTRAL;' or ';BENEFICIAL;'")
