...
//        overhealPenaltyPercentage = mainTag.getDouble("overhealPenaltyPercentage");
    ...
    public static class CommonConfig {
        ...
        public CommonConfig(ForgeConfigSpec.Builder builder) {
            ...
            List<String> defaultSelfReviveList = new ArrayList<>(Arrays.asList(FallenCapability.SELFREVIVETYPE.RANDOM_ITEMS.name(), FallenCapability.SELFREVIVETYPE.CHANCE.name(), FallenCapability.SELFREVIVETYPE.KILL.name(), FallenCapability.SELFREVIVETYPE.STATUS_EFFECTS.name(), FallenCapability.SELFREVIVETYPE.EXPERIENCE.name()));
