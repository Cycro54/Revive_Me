...
//            LOGGER.error("Whats the class thing?? " + reviveType.getClass());
    ...
    public static class CommonConfig {
        ...
        public final ModConfigSpec.ConfigValue<Boolean> showSpecificItemName;
        ...
        public CommonConfig(ModConfigSpec.Builder builder) {
            ...
            penaltyItemData = builder.comment("Item data used to revive fallen players (Only if you selected ITEM as penalty type) (stored in the CUSTOM_DATA Data component) (Don't forget the curly brackets! {}).").define("Revive_Item_Data", "{}", s -> {
                        if (s == null) return false;
                        if (s.equals("{}")) return true;
                        try {
                            return !(TagParser.parseTag((String) s)).isEmpty();
