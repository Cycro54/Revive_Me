...
public class SoundEvents {
    ...
    private static final InvoSound fallen_state_random_sound = new InvoSound(SoundInit.FALLEN_STATE_HEART_BEAT, SoundSource.AMBIENT).setVolume(1F).
...
//            }));
    ...
    public static void fallenNoiseEvent(ClientTickEvent.Pre event){
        ...
        if (ClientUtil.getPlayer().isDeadOrDying()) return;
