...
public class ReviveRequirementScreen {
    ...
    public static void renderRequirements(GuiGraphics stack, InvoZone requirementZone, FallenData cap, float penaltyTypeSize){
    ...
    public static void renderRevivesLeft(GuiGraphics stack, InvoZone requirementZone, FallenData cap){
