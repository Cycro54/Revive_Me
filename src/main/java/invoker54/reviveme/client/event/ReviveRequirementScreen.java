...
public class ReviveRequirementScreen {
    ...
    public static void renderRequirements(MatrixStack stack, InvoZone requirementZone, FallenCapability cap, float penaltyTypeSize) {
        ...
        penaltyText.withStyle(true, InvoTextFormat.filter(TextFormatting.BOLD))
                .withStyle(false, InvoTextFormat.filter(cap.hasEnough(ClientUtil.getPlayer()) ? TextFormatting.GREEN : TextFormatting.RED));
    ...
    public static void renderRevivesLeft(MatrixStack stack, InvoZone requirementZone, FallenCapability cap) {
        ...
        TextUtil.renderText(stack, InvoText.translate("revive_me.fall_plate.revive_count", InvoText.literal(cap.getPlayerReviveCount(true) + "")
                                .withStyle(true, InvoTextFormat.filter((playerReviveCount <= 1 ? TextFormatting.RED : TextFormatting.YELLOW), TextFormatting.BOLD)).getText(),
