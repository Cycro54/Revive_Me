...
public class FallScreenEvent {
    ...
    private static final InvoText selfDestructTxt2 = InvoText.translate(fallenDirectory+"self_destruct_2").withStyle(true, ChatFormatting.RED);    private static final InvoText chanceTxt = InvoText.translate(fallenDirectory + "chance_1");
