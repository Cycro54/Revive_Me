...
public class FallScreenEvent {
    ...
    public static void registerFallenScreen(){
        ...
        OverlayRegistry.registerOverlayTop("fallen_single_player_screen", (gui, stack, partialTicks, width, height) -> {
            ...
            MutableComponent stringToRender = new TranslatableComponent("fallenScreen.single_player.give_chance_1");
            ...
            ClientUtil.blitColor(stack, halfWidth/4F, (halfWidth/2F), startHeight + (halfWidth/2F),
                    20, new Color(0,0,0, 182).getRGB());
            stringToRender = new TranslatableComponent("fallenScreen.single_player.give_chance_2");
            TextUtil.renderText(stack, stringToRender.withStyle(ChatFormatting.BOLD), true, halfWidth/4, (halfWidth/2F),
...
//            (ReviveMeConfig.reviveChance * 100)+"%"
            ...
            stringToRender = new TranslatableComponent("fallenScreen.single_player.give_items");
            ...
            if (cap.usedSacrificedItems() || cap.getItemList().size() == 0){
                ...
                TextUtil.renderText(stack, new TextComponent("X").withStyle(ChatFormatting.DARK_RED), true,
