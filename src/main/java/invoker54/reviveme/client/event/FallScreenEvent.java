...
//    private static final InvoText reviveCountTotalText = InvoText.translate("fallenScreen.revive_count.total");
    ...
    public static void registerFallenScreen(RegisterGuiOverlaysEvent event){
        ...
        event.registerAbove(VanillaGuiOverlay.CHAT_PANEL.id(), "revive_button", ((gui, guiGraphics, partialTick, width, height) ->
        {
...
//            TextUtil.renderText(stack, titleText.getText(), true, 1, titleTextZone, TextUtil.txtAlignment.MIDDLE);
        ...
        switch (selfReviveType) {
            ...
            case STATUS_EFFECTS: {
                ...
                for (MobEffect effect : cap.getNegativeStatusEffects()){
                    ...
                    String s1 = MobEffectUtil.formatDuration(instance, 1.0F).getString();
    ...
    public static double getPartialTicks(){
        return ClientUtil.getMinecraft().getFrameTime();
    }
