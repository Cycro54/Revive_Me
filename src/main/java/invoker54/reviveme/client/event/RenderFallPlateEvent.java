...
//            RenderSystem.disableDepthTest();
            ...
            if (cap.getOtherPlayer() == null) {
                ...
                if (canRender && distance < ReviveMeConfig.deathTimerMaxDistance) {
                    ...
                    //Overkill thing
                    CircleRender.draw3DArc(stack, 0, 0, radius + 4, 0,
                ...
                if (message != null || (lookingAtDownedPlayer && canOverkillRevive)) {
                    ...
                    if (!wasNull && canOverkillRevive){
                        ClientUtil.blit3DColor(stack, txtZone.shiftXY(0, txtZone.height() + 3), blackBg);
                        TextUtil.render3DText(stack, overkillText.getText(), false, 1,
                                txtZone.copy().inflate(-2, -2), TextUtil.txtAlignment.MIDDLE);
                    }
                }
